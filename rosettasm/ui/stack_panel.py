...
class StackPanel(QFrame):
    ...
    # Description:          Initializes the program stack panel                 #
    ...
    #############################################################################
    # Function name:        _create_cell                                        #
    # Description:          Creates a formatted label for the stack display     #
    # Parameters:    str –  text: text to store in the cell                     #
    #                alignment – alignment for the label                        #
    #                QFont – font: optional font for the label                  #
    # Return Value: QLabel – configured cell label                              #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _create_ebp_separator                               #
    # Description:          Creates the visual separator marking the EBP line   #
    # Parameters:    None                                                       #
    # Return Value: QWidget – separator widget                                  #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _build_static_frame                                 #
    # Description:          Builds the static rows for return address and EBP   #
    # Parameters:    None                                                       #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        set_frame_rows_visible                              #
    # Description:          Shows or hides the static stack frame rows          #
    # Parameters:    bool – visible: whether the static rows should be shown    #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        clear_dynamic_rows                                  #
    # Description:          Removes all dynamically generated stack rows        #
    # Parameters:    None                                                       #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        add_stack_row                                       #
    # Description:          Adds a dynamic stack row for a variable or temp     #
    # Parameters:    str –  offset: stack offset label                          #
    #                str –  name: displayed symbol name                         #
    #                str –  value: displayed value                              #
    #                str –  kind: row type ("var" or "temp")                    #
    #                object – symbol: associated symbol object                  #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        populate_from_homes                                 #
    # Description:          Builds dynamic stack rows from operand home mapping #
    # Parameters:    dict – homes: mapping of variables/temps to stack homes    #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _extract_offset                                     #
    # Description:          Extracts numeric EBP-relative offset from home text #
    # Parameters:    str –  home: stack home string                             #
    # Return Value: int – extracted numeric offset                              #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _esp_has_reserved_frame                             #
    # Description:          Checks if ESP indicates reserved local stack space  #
    # Parameters:    object – esp_value: current ESP display value              #
    # Return Value: bool – True if reserved frame space exists                  #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _esp_is_in_active_frame                             #
    # Description:          Checks if ESP is currently within an active frame   #
    # Parameters:    object – esp_value: current ESP display value              #
    # Return Value: bool – True if stack frame is active                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        update_from_snapshot                                #
    # Description:          Updates stack display from an execution snapshot    #
    # Parameters:    object – snapshot: snapshot containing stack state         #
    #                dict – homes: mapping of variables/temps to stack homes    #
    # Return Value: None                                                        #
    #############################################################################
    ...
    # Description:          Formats variable or temp names for stack display    #
    # Parameters:    object – symbol: symbol associated with the stack entry    #
    # Return Value: str – formatted display name                                #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _set_elided_text                                    #
    # Description:          Applies elided text and tooltip to a label          #
    # Parameters:    QLabel – label: label to update                            #
    # Return Value: None                                                        #
    #############################################################################
    ...
    # Description:          Refreshes elided text when the panel is resized     #
    # Parameters:    QResizeEvent – event: resize event object                  #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _base_cell_style                                    #
    # Description:          Returns the default style for stack cells           #
    # Parameters:    None                                                       #
    ...
    # Description:          Returns highlight style for a stack cell color      #
    # Parameters:    str –  color: highlight color name                         #
    # Return Value: str – stylesheet for highlighted cell                       #
    #############################################################################
    ...
    #############################################################################
    # Function name:        clear_stack_highlights                              #
    # Description:          Clears all highlighting from static and dynamic rows#
    # Parameters:    None                                                       #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        _refresh_all_dynamic_cells                          #
    # Description:          Refreshes all visible stack cells after layout      #
    # Parameters:    None                                                       #
    # Return Value: None                                                        #
    #############################################################################
    ...
    #############################################################################
    # Function name:        reset_stack_display                                 #
    # Description:          Resets the entire stack panel to its default state  #
    # Parameters:    None                                                       #
    # Return Value: None                                                        #
    #############################################################################
